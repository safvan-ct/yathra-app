		...
		<div id="section-tickets" className="app-section active section-fade">
			<div className="dashboard-container py-3 mb-5">
				...
				<div className="text-center mb-4">
					...
					<p className="text-muted small">Manage your active and completed trip bookings</p>
				</div>
				...
				<div className="d-flex flex-column gap-4">
					{filteredTickets.length > 0 ? (
						filteredTickets.map((t) => (
							...
							>
								...
								<div
									...
									style={{
										background: "white",
										borderLeft: activeTab === "active" ? "5px solid #0d6efd" : "5px solid #198754"
									}}
								>
									{/* Top section */}
									<div className="p-4 border-bottom border-dashed position-relative">
										...
										<div className="d-flex justify-content-between align-items-center mb-2">
											...
											<div className="d-flex align-items-center gap-1 flex-grow-1 mx-3">
												<div className="border-bottom border-secondary border-dashed w-100" style={{ height: "1px" }}></div>
												<i className="bi bi-bus-front text-primary"></i>
												<div className="border-bottom border-secondary border-dashed w-100" style={{ height: "1px" }}></div>
											</div>
											<h5 className="fw-bold text-dark mb-0 fs-6 text-end">{t.to}</h5>
										</div>
									...
									<div className="p-4 bg-light bg-opacity-50">
										<div className="row g-3 mb-3">
											<div className="col-6">
												<small className="text-muted d-block uppercase fw-bold" style={{ fontSize: "0.65rem", letterSpacing: "0.5px" }}>Bus</small>
												<span className="fw-semibold text-dark fs-7">{t.busName}</span>
												<small className="text-muted d-block" style={{ fontSize: "0.7rem" }}>{t.busNumber}</small>
											</div>
											<div className="col-6">
												<small className="text-muted d-block uppercase fw-bold" style={{ fontSize: "0.65rem", letterSpacing: "0.5px" }}>Date & Time</small>
												<span className="fw-semibold text-dark fs-7">{t.date}</span>
												<small className="text-primary d-block fw-bold" style={{ fontSize: "0.7rem" }}>Dep: {t.departureTime}</small>
											</div>
											<div className="col-6">
												<small className="text-muted d-block uppercase fw-bold" style={{ fontSize: "0.65rem", letterSpacing: "0.5px" }}>Passenger</small>
												<span className="fw-semibold text-dark fs-7">{t.passenger}</span>
												<small className="text-muted d-block" style={{ fontSize: "0.7rem" }}>Seats: {t.seat}</small>
											</div>
											<div className="col-6">
												<small className="text-muted d-block uppercase fw-bold" style={{ fontSize: "0.65rem", letterSpacing: "0.5px" }}>Fare Paid</small>
												<span className="fw-bold text-dark fs-6">{t.fare}</span>
												<small className="text-muted d-block" style={{ fontSize: "0.7rem" }}>{t.gate}</small>
											</div>
										</div>
										...
										{t.status === "active" && (
											<div className="bg-white rounded-3 p-3 border d-flex align-items-center gap-3">
												{/* SVG Mock QR Code */}
												<svg width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-dark">
												...
												<div>
													<span className="d-block fw-bold text-dark small">Digital Boarding Pass</span>
													<small className="text-muted d-block" style={{ fontSize: "0.75rem" }}>Scan QR code at the bus entry gate</small>
												</div>
											</div>
										)}
									</div>
						...
						<div className="text-center py-5 card border-0 rounded-4 shadow-sm bg-white p-4">
							...
							<p className="text-muted small mb-3">You don't have any {activeTab} tickets right now.</p>
							<button className="btn btn-primary rounded-pill px-4 py-2 small" onClick={handleBookNew}>
								Book Ticket Now
							</button>
						</div>
					)}
