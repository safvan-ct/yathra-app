...
/* ─────────────────────────────────────────────────────────────
   Reusable hook: manages ONE Choices instance on a <select> ref
   - wires "search" event → searchStations
   - updates dropdown options whenever stationResults changes
   - syncs selected value → setFieldValue callback
   - properly destroys on unmount
───────────────────────────────────────────────────────────── */
const useChoicesStation = (
	...
	// 1. Boot Choices once the DOM ref is ready
	useEffect(() => {
